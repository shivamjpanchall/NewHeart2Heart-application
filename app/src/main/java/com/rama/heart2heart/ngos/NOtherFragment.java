...
public class NOtherFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_n_other, container, false);
        ...
        chipsDbRef = FirebaseDatabase.getInstance().getReference().child("Other Items Required");
