...
public class NUtensilsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_n_utensils, container, false);
        ...
        chipsDbRef = FirebaseDatabase.getInstance().getReference().child("Utensils Required");
