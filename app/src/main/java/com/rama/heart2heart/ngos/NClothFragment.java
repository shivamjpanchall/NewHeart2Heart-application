...
public class NClothFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_n_cloth, container, false);
        ...
        chipsDbRef = FirebaseDatabase.getInstance().getReference().child("Clothes Requested");
