...
public class DBoardGameFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_d_board_game, container, false);
        ...
        chipsDbRef = FirebaseDatabase.getInstance().getReference().child("Board Games");
