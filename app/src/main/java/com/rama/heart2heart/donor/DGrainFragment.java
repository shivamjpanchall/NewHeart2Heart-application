...
public class DGrainFragment extends Fragment {

    TextInputEditText grain_donation_name,quantity,preferred_pickup_date,preferred_pickup_time,
            preferred_pickup_location,year_grain;
    Button submit_donor;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_d_grain, container, false);
        ...
        chipsDbRef = FirebaseDatabase.getInstance().getReference().child("Grains");
    ...
    private void insertgraindata() {
        ...
        dgrain dgrain = new dgrain(grain_donation_name1,quantity1,preferred_pickup_date1,preferred_pickup_time1,
                preferred_pickup_location1,year_grain1);
