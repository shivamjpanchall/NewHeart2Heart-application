...
public class dbook {
    String book_donation_name1;
    String quantity1;
    String author1;
    String preferred_pickup_date1;
    String preferred_pickup_time1;
    String preferred_pickup_location1;
    public dbook(String book_donation_name1, String quantity1,String author1,String preferred_pickup_date1, String preferred_pickup_time1, String preferred_pickup_location1) {
        this.book_donation_name1 = book_donation_name1;
    ...
    public String getBook_donation_name1() {
        return book_donation_name1;
    }
